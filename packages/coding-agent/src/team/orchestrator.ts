/**
 * Team Orchestration for gajae-code
 *
 ...
 */
export function transitionPhase(state: TeamState, to: TeamPhase | TerminalPhase, reason?: string): TeamState {
	...
	return {
		...
		phase_transitions: [...state.phase_transitions, { from, to, at: new Date().toISOString(), reason }],
	};
}
