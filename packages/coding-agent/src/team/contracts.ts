...
export const TEAM_TERMINAL_DISPATCH_REQUEST_STATUSES: ReadonlySet<TeamDispatchRequestStatus> = new Set([
	"delivered",
	"failed",
]);
export const TEAM_DISPATCH_REQUEST_STATUS_TRANSITIONS: Readonly<
	Record<TeamDispatchRequestStatus, readonly TeamDispatchRequestStatus[]>
> = {
...
export function canTransitionTeamDispatchRequestStatus(
