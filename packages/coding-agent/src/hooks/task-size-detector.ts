 ...
 * (mandatory enforcement). In GJC, Codex CLI does not support pre-tool hooks, so this
 * module serves as:
 ...
 *
 * The actual gate enforcement in GJC is advisory: AGENTS.md instructs the model to
 ...
 */
export function classifyTaskSize(text: string, thresholds: TaskSizeThresholds = DEFAULT_THRESHOLDS): TaskSizeResult {
