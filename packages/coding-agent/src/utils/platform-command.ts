import { type SpawnSyncOptionsWithStringEncoding, type SpawnSyncReturns, spawnSync } from "child_process";
...
function resolveWindowsCommandPath(command: string, env: NodeJS.ProcessEnv, existsImpl: ExistsSyncLike): string | null {
...
function resolvePosixCommandPath(command: string, env: NodeJS.ProcessEnv, existsImpl: ExistsSyncLike): string | null {
...
function shouldRetryWithNodeHost(
	spec: PlatformCommandSpec,
